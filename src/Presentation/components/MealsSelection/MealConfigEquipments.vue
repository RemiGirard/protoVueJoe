...
import Ban from "@/Presentation/icons/Ban.vue";
import FireBurner from "@/Presentation/icons/FireBurner.vue";
import SnowFlake from "@/Presentation/icons/SnowFlake.vue";
  ...
  <DropdownConfig>
    <template #button>
      <div style="display: flex; flex-direction: row; justify-content: space-around;">
        <FireBurner style="width: 50px;height: 20px;"/>
      </div>
